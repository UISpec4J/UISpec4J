 ...
 * 
 * @see <a href="http://www.uispec4j.org/intercepting-windows">Intercepting
 *      windows</a>
 */
public class UISpecToolkit extends ToolkitDelegate {
	...
	/**
	 * @see UISpec4J#init
	 * @deprecated Do not call this one directly anymore - use
	 *             {@link UISpec4J#init} instead
	 */
	@Deprecated
	 ...
	 * <p>
	 * This method will only work properly if the toolkit has not yet been
	 * instanciated by Swing.
	 */
	...
	public KeyboardFocusManagerPeer createKeyboardFocusManagerPeer(
			KeyboardFocusManager keyboardFocusManager) throws HeadlessException {
		return null;
	}
	...
	private static void buildUnderlyingToolkit(String awtToolkit) {
		try {
			underlyingToolkit = (Toolkit) Class.forName(awtToolkit)
					.newInstance();
		} catch (Exception e) {
	...
	public KeyboardFocusManagerPeer getKeyboardFocusManagerPeer()
		...
		return peerProvider.getKeyboardFocusManagerPeer();
	}
}
